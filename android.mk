...
# Align some sections in the APK archive. (Apparently this used to be optional but recommended for performance, but the `-P 16` is now required.)
# For why we use `-P 16`, see: https://developer.android.com/guide/practices/page-sizes
...
$(ANDROID_APK_UNSIGNED_ALIGNED): $(ANDROID_APK_UNSIGNED)
	$(ANDROID_SDK)/build-tools/$(ANDROID_BUILD_TOOLS)/zipalign -f -P 16 4 $< $@
